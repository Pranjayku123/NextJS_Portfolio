...
// import { ConfettiDemo } from "@/components/Experience/confitti";
import companyLogo from "@/assets/images/pilog-logo-trans-bg.png"

function Experence() {
  return (
    <div className="relative w-full  bg-[var(--bgColor)] text-teal-50 mx-auto size-[500px] px-4 font-shantell">
